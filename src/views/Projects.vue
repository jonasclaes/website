<template>
  <div>
    ...
    >
      <div class="container mx-auto">
        <div class="max-w-6xl mx-auto p-4">
          <div
            class="h-screen flex flex-col sm:flex-row-reverse space-y-10 sm:space-x-reverse sm:space-x-10 sm:space-y-0 lg:space-x-reverse lg:space-x-20 justify-center items-center"
          >
    ...
    <!-- <div>
      <div class="container mx-auto">
        <div class="max-w-6xl mx-auto p-4" id="#projects"></div>
      </div>
    </div> -->
    <Footer></Footer>
  </div>
